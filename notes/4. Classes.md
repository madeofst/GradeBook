...
With this, you don't even have to write the underlying private variable.  In a lot of cases, this isn't any different but in some cases in dotnet uses properties and public variables differently.  Probably don't need to worry about it.  One time where you can use it is if you want to make, for tinstance, the `set` private:
